...
import { Box, Image, Heading, Button, Text, Flex, Spacer, Wrap, WrapItem, Grid, Center, VStack, AbsoluteCenter } from '@chakra-ui/react';
import { Card, CardHeader, CardBody, CardFooter } from '@chakra-ui/react';

const FarmPackages = () => {
  return (
    <section className="box-border mt-40" 
    >
      
      <Container>

        <Wrapper className="flex flex-col lg:grid grid-cols-3 gap-6">
