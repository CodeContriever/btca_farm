...
const Nav = ({ children, style, ...props }) => {
  const NavStyle = {
  ...
  // const ExpandHandler = () => {
  //   setHamburger(true);
  //   const collapse = new Collapse(targetRef.current, triggerRef.current);
  //   collapse.expand();
  // };
  ...
  useEffect(() => {
    collapse = new Collapse(targetRef.current, triggerRef.current)
  }, [collapse])
    ...
    <nav class="bg-none border-gray-200 dark:bg-gray-900">
      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="/landing" class="flex items-center">
          <img src="/logo.png" class="h-8 mr-3" alt="BTCA_FARM Logo" />
          ...
          <>
            {
              hamburger ? (
                <button
                  ...
                  id='triggerEl'
                  class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2"
                  aria-expanded="false">
        ...
        <use xlink:href="#a" y="420"/><use xlink:href="#a" y="840"/><use xlink:href="#a" y="1260"/></g><use xlink:href="#a" y="1680"/></g><use xlink:href="#b" x="247" y="210"/></g><use xlink:href="#c" x="494"/></g><use xlink:href="#d" x="988"/><use xlink:href="#c" x="1976"/><use xlink:href="#e" x="2470"/>
        </g>
        </svg> */}
                  English (US)
                </button>
        ...
        {/* Nav items */}
        <Wrapper class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
          <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:border-0">
            ...
            <li>
              <Button
                ...
                class="text-secondary rounded-md bg-#A020F0 border-0 m-0 font-normal font-inter rounded-6 outline-none text-gray-700 cursor-pointer"
              >
                <svg
                  height="28"
                  width="28"
