...
const Nav = ({ children, style, ...props }) => {
  ...
  return (
    ...
    // <nav class=" bg-none border-gray-200 dark:bg-gray-900">
      ...
      <div class="border-gray-200 dark:bg-gray-900 flex flex-wrap items-center justify-between">
        ...
        <Wrapper class="w-auto px-4 lg:px-0 flex items-center order-2">
        <Wrapper class="hidden lg:flex items-center order-2">

          {/* Nav items */}
          <Box class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        ...
        <use xlink:href="#a" y="420"/><use xlink:href="#a" y="840"/><use xlink:href="#a" y="1260"/></g><use xlink:href="#a" y="1680"/></g><use xlink:href="#b" x="247" y="210"/></g><use xlink:href="#c" x="494"/></g><use xlink:href="#d" x="988"/><use xlink:href="#c" x="1976"/><use xlink:href="#e" x="2470"/>
          ...
          <button
            ...
            id='triggerEl'
            class="inline-flex items-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2"
            aria-expanded="false"
          >
            {showMenu ? (
              <MdOutlineCancel
      ...
      {showMenu && (
        <Wrapper
          class="z-50 w-full my-4 text-base list-none bg-white divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
