        ...
        <Main>
          ...
          <Container>
            ...
            >
              ...
              <div className="box-border" >
                ...
                >
                  ...
                  <Wrapper className="box-border">
                    <h1
                      className="box-border mb-0 mt-0 text-gray-800 text-[16px] font-medium leading-6"
                    >
                      Applications
                    </h1>{" "}
                    <p
                      className="box-border mb-0 text-gray-600 text-sm leading-5 break-words mt-2"
                    >
                      BTCA Technologies
                    </p>
                  </Wrapper>{" "}
              ...
              <Wrapper
                className="box-border mt-6 rounded-md bg-white shadow-md"
              >
                <Box
                  className="box-border p-[24px]"
                >
                  <p
                    className="box-border mb-0 mt-0 text-gray-600 text-sm leading-5 break-words"
                  >
                    {
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <Box>
                          <h6
                            className="box-border mb-0 mt-0 text-[#2b2d33] text-lg font-bold leading-6 break-words flex items-center uppercase"
                          >
                            {"BTCA Wallet"}
                            <span
                          ...
                          <p
                            className="box-border mb-0 text-[#0078d2] text-base leading-5 break-words mt-2"
                          >
                            PLATINEXLLC
                          </p>
                        </Box>
