          ...
          <Container>
            ...
            >
              <div className="box-border flex flex-col gap-6">
                ...
                <p
                  className="mb-0 mt-0 text-gray-800 text-base font-medium leading-6"
                >
                      ...
                      <AccordionPanel pb={4}>
                        ...
                        >
                          <div className="box-border">
                            <p
                              className="box-border mt-0 text-gray-600 text-sm font-medium leading-6 mb-[24px]"
                            >
                          ...
                          <Card
                            ...
                            <CardBody>
                              ...
                              >
                                <h1
                                  className="box-border mb-0 text-gray-700 text-sm  font-medium leading-5 mt-4"
                                >
                                  Drag and drop your photo here
                                </h1>

                                <p
                                  className="box-border mb-0 text-gray-400 text-sm leading-5 break-words mt-2"
                                >
                                  or click to browse
                                </p>
